<template>
  <section class="bg-white dark:bg-gray-900  w-full max-h-full">
    <div class="container px-6 py-10 mx-auto xl:mt-60">
      <div class="lg:flex lg:items-center">
        <div class="w-full space-y-12 lg:w-1/2 ">
          <div>
            <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white ">
              網站誕生的契機 <br>
              The <span class="text-stone-600 bg-gray-100">motivation</span>
              <br>behind the birth of the Blog
            </h1>

            <div class="mt-2">
              <span class="inline-block w-40 h-1 rounded-full bg-stone-700" />
              <span class="inline-block w-3 h-1 ml-1 rounded-full bg-purple-500" />
              <span class="inline-block w-1 h-1 ml-1 rounded-full bg-stone-500" />
            </div>
          </div>
          ...
          <div class="md:flex md:items-start md:-mx-4">
            ...
            <div class="mt-4 md:mx-4 md:mt-0 font-Chinese">
              ...
              <p class="mt-3 text-gray-500 dark:text-gray-300 text-xl">
                身為資工人，沒有一個自己的Website好像說不過去XD<br>
                在忙炸天的大三上學期，我決定開始做一個自己的部落格，<br>
                偶爾想要分享許多生活中遇到的趣事! 和照片~
              </p>
            </div>
          </div>
          ...
          <div class="md:flex md:items-start md:-mx-4">
            ...
            <div class="mt-4 md:mx-4 md:mt-0 font-Chinese font-extrabold">
              <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">
          ...
          <div class="md:flex md:items-start md:-mx-4">
            ...
            <div class="mt-4 md:mx-4 md:mt-0 font-Chinese">
              ...
              <p class="mt-3 text-gray-500 dark:text-gray-300 text-xl">
                由於站主aka 林米奇 最近有六個專題要做，<br>大專生計畫，下次更新可能年後
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="flex md:flex-row flex-col">
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/DlvVJo4YHrs?si=fUS9S0t-a9xncXQR"
          title="YouTube video player"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowfullscreen
          class="flex mt-8 scale-75 md:scale-100 self-center"
        />
        <div class="flex flex-col">
          <p class="flex mt-16 md:ml-32 md:justify-center text-4xl font-Bungee text-black text-center">
            Recent creations
          </p>
          <p class="flex  justify-center text-2xl font-Chinese hidden text-black">
            最近的小作品
          </p>
          <p class="flex mt-8 md:ml-32 text-center font-Willfteka">
            I have recently developed a vehicle detection system using YOLOv8 for intersection traffic monitoring. <br>
            This system accurately identifies and tracks vehicles as they pass through the intersection in real-time.<br>
            By leveraging the advanced object detection capabilities of YOLOv8,<br>
            we are able to achieve high detection accuracy and efficiency. <br>
            The system power by supervision YOLOV8 openCV
          </p>
        </div>
      </div>
    </div>
