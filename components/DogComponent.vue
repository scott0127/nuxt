<template>
  <div ref="dogboss" class="containerForDog">
    <div class="corgi">
      <div class="head">
        <div class="ear ear--r" />
        <div class="ear ear--l" />
        ...
        <div class="face">
          <div class="face__white">
            <div class=" face__orange face__orange--l" />
            <div class=" face__orange face__orange--r" />
          </div>
        </div>

        <div class="face__curve" />

        <div class="mouth">
          <div class="nose" />
          <div class="mouth__left">
            <div class="mouth__left--round" />
            <div class="mouth__left--sharp" />
          </div>

          <div class="lowerjaw">
            <div class="lips" />
            <div class="tongue test" />
          </div>
      ...
      <div class="neck__back" />
      <div class="neck__front" />

      <div class="body">
        <div class="body__chest" />
      </div>

      <div class="foot foot__left foot__front foot__1" />
      <div class="foot foot__right foot__front foot__2" />
      <div class="foot foot__left foot__back foot__3" />
      <div class="foot foot__right foot__back foot__4" />
...
export default {
  ...
  methods: {
    handleScroll (_event) {
      if (window.scrollY === 0) {
        this.$refs.dogboss.classList.add('scale-150')
      } else {
...
.corgi .foot__1 {
  right: 37%;
  animation: leg-shake 2s none infinite;
  transform-origin: top ;
}
.corgi .foot__2 {
  right: 15%;
  transform-origin: top ;
  animation: leg-shake2 2s none infinite;
}
